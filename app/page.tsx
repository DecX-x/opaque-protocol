    ...
    <header className="relative min-h-screen flex items-center justify-center pt-24 hero-mesh overflow-hidden">
      <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
        ...
        >
          <Link
            href="/app"
            className="w-full sm:w-auto bg-[var(--primary)] text-white px-10 py-4 rounded-2xl text-lg font-bold shadow-xl shadow-pink-200 hover:translate-y-[-2px] transition-all cursor-pointer inline-block"
          >
            Launch App
          </Link>
